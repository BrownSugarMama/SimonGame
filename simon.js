// Similar to HTML, js indentation should reflect nested elements. Opening and closing curly braces '{}' should be indented the same number of spaces to clearly identify the start and stop of a code block.
// best practice is to use '===' instead of '=='
// code could be made more dry, especially in the section that gives functionality to each square. Consider functions that could be used for every square.
